...
export interface SecurityImprovementPlan {
  summary: SecuritySummary;
  criticalVulnerabilities: CriticalVulnerability[];
  implementationPhases: Phase[];
  frontendCompatibility: FrontendCompatibility;
}
...
export interface SecuritySummary {
  ...
  frontendBreakingChanges: number;
}
...
export interface FrontendCompatibility {
  apiChanges: boolean;
  responseStructureChanges: boolean;
  newValidationErrors: boolean;
 ...
 */
export const CRITICAL_VULNERABILITIES: CriticalVulnerability[] = [
  {
    id: "CRIT-001",
    ...
    description:
      "Les paramètres de recherche ne sont pas sanitisés et peuvent permettre des injections NoSQL",
  ...
  },
  {
    ...
    description:
      "Utilisation de Utils.saveFile au lieu du système sécurisé uploadProductImages",
  ...
  },
  {
    ...
    description:
      "Validation insuffisante contre les attaques XSS dans name, description, etc.",
    ...
    tasks: [
      {
        ...
        description:
          "Ajouter sanitization et validation des paramètres de recherche pour prévenir les injections NoSQL",
        files: [
      ...
      },
      {
        ...
        description:
          "Utiliser le système d'upload sécurisé existant dans createProduct et updateProduct",
    ...
    tasks: [
      {
        ...
        description:
          "Ajouter une protection contre les abus sur les endpoints publics",
        files: [
      ...
      },
      {
        ...
        description:
          "Validation stricte de tous les paramètres de requête et URL",
        files: [
          "src/controllers/product.controller.ts",
 ...
 */
export const FRONTEND_COMPATIBILITY: FrontendCompatibility = {
  apiChanges: false,
