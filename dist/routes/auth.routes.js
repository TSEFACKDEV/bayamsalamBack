...
router.post("/resend-otp", rateLimiter_js_1.authRateLimiter, (0, validation_js_1.default)(auth_validation_js_1.resendOTPSchema), auth_controller_js_1.resendOTP); // 🚦 Rate limiting + Nouveau endpoint
