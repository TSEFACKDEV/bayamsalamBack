...
export function reviewProductTemplate({
  userName,
  productName,
  status,
  message,
  ...
  const statusText =
    status === "VALIDATED" ? "Validée" : "Refusée et Supprimée";
...
<body>
  <div class="email-container">
    ...
    <div class="footer">
      ...
      <p>Cet email a été généré automatiquement suite à la ${
        status === "VALIDATED" ? "validation" : "modération"
      } de votre annonce</p>
