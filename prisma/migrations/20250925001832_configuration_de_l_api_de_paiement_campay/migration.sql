...
CREATE TABLE `Payment` (
    ...
    `paymentMethod` ENUM('MOBILE_MONEY', 'ORANGE_MONEY') NOT NULL,
    ...
    INDEX `Payment_campayReference_idx`(`campayReference`),
    PRIMARY KEY (`id`)
...
-- AddForeignKey
ALTER TABLE `Payment` ADD CONSTRAINT `Payment_forfaitId_fkey` FOREIGN KEY (`forfaitId`) REFERENCES `Forfait`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
